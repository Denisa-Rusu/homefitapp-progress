...
public class TrackWeekOneWorkout extends AppCompatActivity {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            week1caloriesburned = findViewById(R.id.weekonecalsburned);
                            week1caloriesburned.setText(totalCaloriesBurned);
                        }
                    }
    ...
    public void calculateWeekOneCalories(View view) {
        ...
        week1totalcalories = day1exercise1calories + day2exercise1calories + day3exercise1calories + day4exercise1calories + day5exercise1calories
                + day1exercise2calories + day2exercise2calories + day3exercise2calories + day4exercise2calories + day5exercise2calories;

        totalcalsweek1 = String.valueOf(week1totalcalories);

        week1caloriesburned.setText(totalcalsweek1);
        ...
        String w1cb = week1caloriesburned.getText().toString();
        ...
        UserWorkout userWorkout= new UserWorkout(day1Exercise1Reps, day1Exercise1Sets, d1e1,
                ...
                day5Exercise2Reps, day5Exercise2Sets, d5e2, w1cb);

        DatabaseReference fireDB = FirebaseDatabase.getInstance().getReference("Users").child(Uid).child("WeekOneWorkout").push();

        fireDB.setValue(userWorkout);

    }

    public void finishWeekOne(View view) {

        Intent intent = new Intent(TrackWeekOneWorkout.this, WorkoutActivity.class);
        Toast.makeText(TrackWeekOneWorkout.this, "You have finished your Week One Workout", Toast.LENGTH_LONG).show();
