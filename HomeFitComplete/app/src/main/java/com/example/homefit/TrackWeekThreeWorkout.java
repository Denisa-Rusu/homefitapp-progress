...
public class TrackWeekThreeWorkout extends AppCompatActivity {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            week3caloriesburned.setText(totalCaloriesBurned);
                        }
                    }
    ...
    public void finishWeekThree(View view) {

        Intent intent = new Intent(TrackWeekThreeWorkout.this, WorkoutActivity.class);
        Toast.makeText(TrackWeekThreeWorkout.this, "You have finished your Week Three Workout", Toast.LENGTH_LONG).show();
