...
public class TrackWeekOneWorkout extends AppCompatActivity {
    ...
    public final static String key1 = "WEEK ONE TOTAL CALORIES";
    ...
    public void finishPlan(View view) {
        ...
        Intent intent = new Intent(TrackWeekOneWorkout.this, RecordActivity.class);
        intent.putExtra(key1, w1cb);
        Toast.makeText(TrackWeekOneWorkout.this, "You have ended your plan", Toast.LENGTH_LONG).show();
