...
public class TrackWeekFourWorkout extends AppCompatActivity {
    ...
    public void finishPlan(View view) {
        ...
        Intent intent = new Intent(TrackWeekFourWorkout.this, RecordActivity.class);
        intent.putExtra(key1, w4cb);
        Toast.makeText(TrackWeekFourWorkout.this, "You have ended your plan", Toast.LENGTH_LONG).show();
