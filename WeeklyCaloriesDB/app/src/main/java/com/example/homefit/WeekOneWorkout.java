...
public class WeekOneWorkout extends AppCompatActivity {
    ...
    public static final String key1 = "DAY01EX1REPS";
    public static final String key2 = "DAY01EX1SETS";
    public static final String key3 = "DAY02EX1CalORIES";
    ...
    public void trackWorkout(View view) {
        ...
        startActivity(new Intent(WeekOneWorkout.this, TrackWeekOneWorkout.class));
