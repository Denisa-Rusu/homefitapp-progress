...
public class TrackWeekTwoWorkout extends AppCompatActivity {
    ...
    public void finishPlan(View view) {
        ...
        Intent intent = new Intent(TrackWeekTwoWorkout.this, RecordActivity.class);
        intent.putExtra(key1, w2cb);
        Toast.makeText(TrackWeekTwoWorkout.this, "You have ended your plan", Toast.LENGTH_LONG).show();
