...
public class ArmWorkoutAdvice extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arm_workout_advice);
    ...
    public void goBack(View view) {
        ...
        Intent intent = new Intent(ArmWorkoutAdvice.this, DetailsActivity.class);
