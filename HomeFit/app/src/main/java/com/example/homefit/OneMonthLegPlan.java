...
public class OneMonthLegPlan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_month_leg_plan);

        Intent intent = getIntent();
        TextView oneMonthLegPlan = findViewById(R.id.one_month_leg_plan);
        oneMonthLegPlan.getText().toString();
        ...
        TextView legPlan = findViewById(R.id.one_month_leg_plan);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_profile:
                Intent intent = new Intent(OneMonthLegPlan.this, ProfileActivity.class);
                startActivity(intent);
                return true;
            case R.id.action_progress:
                Intent intent1 = new Intent(OneMonthLegPlan.this, OneMonthProgress.class);
                startActivity(intent1);
                return true;
            case R.id.action_guide:
                Intent intent2 = new Intent(OneMonthLegPlan.this, LegWorkoutGuide.class);
