...
public class ModerateLegPlan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moderate_leg_plan);

        Intent intent = getIntent();
        TextView moderateLegPlan = findViewById(R.id.moderate_leg_plan);
        moderateLegPlan.getText().toString();

        plans = new ArrayList<UserPlan>();
        mAuth = FirebaseAuth.getInstance();
        Uid = mAuth.getCurrentUser().getUid();

        TextView legPlan = findViewById(R.id.moderate_leg_plan);
        TextView calories = findViewById(R.id.modcalories);
        ...
        UserPlan moderatePlan = new UserPlan(caloriesToBurn, chosenPlan, day01, day01performance, day02, day02performance,
    ...
    public void goToWorkout(View view) {
        Intent intent = new Intent(ModerateLegPlan.this, WorkoutActivity.class);
