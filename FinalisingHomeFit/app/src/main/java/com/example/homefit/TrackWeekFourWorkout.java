...
public class TrackWeekFourWorkout extends AppCompatActivity {

    public final static String key1 = "WEEK FOUR TOTAL CALORIES";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_track_week_four_workout);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            String day1Exercise1CaloriesBurned = snapshot.child("day1Exercise1CaloriesBurned").getValue().toString();
                            String day1Exercise2CaloriesBurned = snapshot.child("day1Exercise2CaloriesBurned").getValue().toString();
                            String day2Exercise1CaloriesBurned = snapshot.child("day2Exercise1CaloriesBurned").getValue().toString();
                            String day2Exercise2CaloriesBurned = snapshot.child("day2Exercise2CaloriesBurned").getValue().toString();
                            String day3Exercise1CaloriesBurned = snapshot.child("day3Exercise1CaloriesBurned").getValue().toString();
                            String day3Exercise2CaloriesBurned = snapshot.child("day3Exercise2CaloriesBurned").getValue().toString();
                            String day4Exercise1CaloriesBurned = snapshot.child("day4Exercise1CaloriesBurned").getValue().toString();
                            String day4Exercise2CaloriesBurned = snapshot.child("day4Exercise2CaloriesBurned").getValue().toString();
                            String day5Exercise1CaloriesBurned = snapshot.child("day5Exercise1CaloriesBurned").getValue().toString();
                            String day5Exercise2CaloriesBurned = snapshot.child("day5Exercise2CaloriesBurned").getValue().toString();
                            String totalCaloriesBurned = snapshot.child("totalCaloriesBurned").getValue().toString();

                            day1ex1calories = findViewById(R.id.day1ex1calories);
                            day1ex1calories.setText(day1Exercise1CaloriesBurned);
                            day1ex2calories = findViewById(R.id.day1ex2calories);
                            day1ex2calories.setText(day1Exercise2CaloriesBurned);
                            day2ex1calories = findViewById(R.id.day2ex1calories);
                            day2ex1calories.setText(day2Exercise1CaloriesBurned);
                            day2ex2calories = findViewById(R.id.day2ex2calories);
                            day2ex2calories.setText(day2Exercise2CaloriesBurned);
                            day3ex1calories = findViewById(R.id.day3ex1calories);
                            day3ex1calories.setText(day3Exercise1CaloriesBurned);
                            day3ex2calories = findViewById(R.id.day3ex2calories);
                            day3ex2calories.setText(day3Exercise2CaloriesBurned);
                            day4ex1calories = findViewById(R.id.day4ex1calories);
                            day4ex1calories.setText(day4Exercise1CaloriesBurned);
                            day4ex2calories = findViewById(R.id.day4ex2calories);
                            day4ex2calories.setText(day4Exercise2CaloriesBurned);
                            day5ex1calories = findViewById(R.id.day5ex1calories);
                            day5ex1calories.setText(day5Exercise1CaloriesBurned);
                            day5ex2calories = findViewById(R.id.day5ex2calories);
                            day5ex2calories.setText(day5Exercise2CaloriesBurned);
                            week4caloriesburned = findViewById(R.id.weekfourcalsburned);
                            week4caloriesburned.setText(totalCaloriesBurned);
                        }
                    }
    ...
    public void calculateWeekFourCalories(View view) {
        ...
        week4totalcalories = day1exercise1calories + day2exercise1calories + day3exercise1calories + day4exercise1calories + day5exercise1calories
                + day1exercise2calories + day2exercise2calories + day3exercise2calories + day4exercise2calories + day5exercise2calories;

        totalcalsweek4 = String.valueOf(week4totalcalories);

        week4caloriesburned.setText(totalcalsweek4);
        ...
        String w4cb = week4caloriesburned.getText().toString();
        ...
        UserWorkout userWorkout= new UserWorkout(day1Exercise1Reps, day1Exercise1Sets, d1e1,
                ...
                day5Exercise2Reps, day5Exercise2Sets, d5e2, w4cb);

        DatabaseReference fireDB = FirebaseDatabase.getInstance().getReference("Users").child(Uid).child("WeekFourWorkout").push();

        fireDB.setValue(userWorkout);

    }

    public void finishWeekFour(View view) {

        Intent intent = new Intent(TrackWeekFourWorkout.this, WorkoutActivity.class);
        Toast.makeText(TrackWeekFourWorkout.this, "You have finished your Week Four Workout", Toast.LENGTH_LONG).show();
