...
public class TrackWeekTwoWorkout extends AppCompatActivity {

    public final static String key1 = "WEEK TWO TOTAL CALORIES";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_track_week_two_workout);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            week2caloriesburned = findViewById(R.id.weektwocalsburned);
                            week2caloriesburned.setText(totalCaloriesBurned);
                        }
                    }
    ...
    public void calculateWeekTwoCalories(View view) {
        ...
        week2totalcalories = day1exercise1calories + day2exercise1calories + day3exercise1calories + day4exercise1calories + day5exercise1calories
                + day1exercise2calories + day2exercise2calories + day3exercise2calories + day4exercise2calories + day5exercise2calories;

        totalcalsweek2 = String.valueOf(week2totalcalories);

        week2caloriesburned.setText(totalcalsweek2);
        ...
        String w2cb = week2caloriesburned.getText().toString();
        ...
        UserWorkout userWorkout= new UserWorkout(day1Exercise1Reps, day1Exercise1Sets, d1e1,
                ...
                day5Exercise2Reps, day5Exercise2Sets, d5e2, w2cb);

        DatabaseReference fireDB = FirebaseDatabase.getInstance().getReference("Users").child(Uid).child("WeekTwoWorkout").push();

        fireDB.setValue(userWorkout);

    }

    public void finishWeekTwo(View view) {

        Intent intent = new Intent(TrackWeekTwoWorkout.this, WorkoutActivity.class);
        Toast.makeText(TrackWeekTwoWorkout.this, "You have finished your Week Two Workout", Toast.LENGTH_LONG).show();
