...
public class IntenseAbPlan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intense_ab_plan);


        Intent intent = getIntent();
        TextView intenseAbPlan = findViewById(R.id.intense_ab_plan);
        intenseAbPlan.getText().toString();
        ...
        TextView absPlan = findViewById(R.id.intense_ab_plan);
    ...
    public void goToWorkout(View view) {
        Intent intent = new Intent(IntenseAbPlan.this, WorkoutActivity.class);
