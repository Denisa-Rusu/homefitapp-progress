...
public class DetailsActivity extends AppCompatActivity {
    ...
    public void submitDetails(View view) {
        ...
        if (ctb.equalsIgnoreCase("Less than 1,000 Cals") && fg.equalsIgnoreCase("Arms") && fa.equalsIgnoreCase("Inactive")) {
            ...
            Intent intent = new Intent(this, ArmWorkoutAdvice.class);
            startActivity(intent);
            return;
            ...
            Intent intent = new Intent(this, LegWorkoutAdvice.class);
            startActivity(intent);
            return;
            ...
            Intent intent = new Intent(this, ChestWorkoutAdvice.class);
            startActivity(intent);
            return;
            ...
            Intent intent = new Intent(this, GluteWorkoutAdvice.class);
            startActivity(intent);
            return;
            ...
            Intent intent = new Intent(this, AbWorkoutAdvice.class);
            startActivity(intent);
            return;
        }
